...
class OllamaClient:
    ...
    def __init__(self, base_url: str = "http://100.64.0.34:11434", model: str = "qwen2.5:1.5b"):
...
def init_ollama_client(base_url: str = "http://100.64.0.34:11434", model: str = "qwen2.5:1.5b"):
