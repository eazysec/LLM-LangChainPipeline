...
class OllamaClient:
    ...
    def __init__(self, base_url: str = "http://100.64.0.34:11434", model: str = "qwen2.5vl:72b"):
...
def init_ollama_client(base_url: str = "http://100.64.0.34:11434", model: str = "qwen2.5vl:72b"):
...
def check_ollama_setup():
    ...
    if not client.is_available():
        return {
            "available": False,
            "error": "Ollama n'est pas accessible. Assurez-vous qu'il fonctionne sur 100.64.0.34:11434"
        }
